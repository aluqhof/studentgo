...
import 'package:student_go/widgets/event_card_horizontal_list.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            (!_isLoading)
                ? EventCardHorizontalList(cityName: _currentCity)
                : const Center(
                    child: CircularProgressIndicator(),
                  ) // O cualquier otro widget que desees mostrar mientras se carga la ciudad
          ],
        ),
