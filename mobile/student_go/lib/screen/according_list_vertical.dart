...
class AccordingListVertical extends StatefulWidget {
  final String cityName;

  const AccordingListVertical({Key? key, required this.cityName})
      : super(key: key);

  @override
  State<AccordingListVertical> createState() => _AccordingListVerticalState();
}
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newItems = await _eventListBloc.eventRepository
          .getAccordingEventsLimited(widget.cityName, pageKey, _pageSize);
