...
class StudentRepositoryImp extends StudentRepository {
  ...
  Future<StudentInfoResponse> getStudentProfile() async {
    try {
      final response = await _httpClient.get(
        Uri.parse('http://192.168.1.153:8080/student/'),
  ...
  Future<StudentInfoResponse> saveOrUnsaveEvent(String eventId) async {
    try {
      final response = await _httpClient.put(
        Uri.parse('http://192.168.1.153:8080/student/save-unsave-event/$eventId'),
        //Uri.parse('http://192.168.1.153:8080/auth/login'),
      );
  ...
  Future<List<Content>> getAllSavedEvents() async {
    try {
      final response = await _httpClient.get(
        Uri.parse('http://192.168.1.153:8080/student/saved-events'),
        //Uri.parse('http://192.168.1.153:8080/auth/login'),
      );
  ...
  Future<ChangeUserNameResponse> changeUsername(
    ...
    try {
      final response = await _httpClient.put(
        Uri.parse('http://192.168.1.153:8080/user/change-username'),
        //Uri.parse('http://192.168.1.153:8080/auth/login'),
  ...
  Future<StudentInfoResponse> updateProfile(
    ...
    try {
      final response = await _httpClient.put(
        Uri.parse('http://192.168.1.153:8080/user/student/update'),
        //Uri.parse('http://192.168.1.153:8080/auth/login'),
  ...
  Future<Uint8List> getUserPhoto() async {
    try {
      final response = await _httpClient.get(
        Uri.parse('http://192.168.1.153:8080/download-profile-photo'),
      );
  ...
  Future<Uint8List> getUserPhotoById(String id) async {
    try {
      final response = await _httpClient.get(
        Uri.parse('http://192.168.1.153:8080/download-profile-photo/$id'),
      );
  ...
  Future<UploadResponse> uploadProfilePhoto(XFile image) async {
    try {
      ...
      final request = http.MultipartRequest(
        'POST',
        Uri.parse('http://192.168.1.153:8080/upload-profile-image'),
      );
